...
/**
 * Hook sub-interface of {@link Effect} whose sub-interfaces allow for the modification of the client's visual display by providing commonly-used methods that allow for the alteration of rendered elements on-screen (Static/animated overlays,
 ...
 */
public interface ScreenEffect extends Effect {
